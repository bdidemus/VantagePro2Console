...
class MySQL {
	...
	var $sUsername = "USER"; 	// MySQL Username
	var $sPassword = "PASSWORD";	// MySQL Password
	var $sDatabase = "weatherstation";	// MySQL Database
	...
	function ArrayResult(){
		$this->aArrayedResult = mysql_fetch_array($this->aResult);
